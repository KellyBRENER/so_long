...
/*   Updated: 2024/04/15 16:30:24 by kbrener-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
2. check_map.c :
	...
	- la map doit contenir 1 sortie (E), au moins un item (C),
	une position de depart (P) (pas de doublons)
...
3. construct_map.c :
	...
	- peut-etre compose de 5 elements : emplacements vides (0), murs (1),
	items (C), sortie (E), position de depart (P)
4. player.c
...
6. bonus.c :
	...
	- le compte total des points est directement affiche dans la fenetre
	plutot que dans le shell
*/
